...
import com.takeoffandroid.recyclerviewtemplate.adapter.HeaderListAdapter;
...
public class HeaderListActivity extends AppCompatActivity {
    ...
    private void setAdapter() {
        ...
        mAdapter = new HeaderListAdapter(HeaderListActivity.this, modelList, "Header");
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(HeaderListActivity.this, R.drawable.divider_recyclerview));
        recyclerView.addItemDecoration(dividerItemDecoration);

        recyclerView.setAdapter(mAdapter);


        mAdapter.SetOnItemClickListener(new HeaderListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(HeaderListActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
        ...
        mAdapter.SetOnHeaderClickListener(new HeaderListAdapter.OnHeaderClickListener() {
            @Override
            public void onHeaderClick(View view, String headerTitle) {

                //handle item click events here
                Toast.makeText(HeaderListActivity.this, "Hey I am a header", Toast.LENGTH_SHORT).show();
