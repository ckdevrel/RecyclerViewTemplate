...
public class BannerListActivity extends AppCompatActivity {
    ...
    private void setAdapter() {
        ...
        mAdapter = new BannerListAdapter(BannerListActivity.this, modelList);
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(BannerListActivity.this, R.drawable.divider_recyclerview));
        recyclerView.addItemDecoration(dividerItemDecoration);

        recyclerView.setAdapter(mAdapter);


        mAdapter.SetOnItemClickListener(new BannerListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(BannerListActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
