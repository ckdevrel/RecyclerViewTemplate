 ...
 */
public class SimpleGridAllCardsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SimpleGridAllCardsAdapter(Context context, ArrayList<AbstractModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_simple_grid_all_cards, viewGroup, false);
