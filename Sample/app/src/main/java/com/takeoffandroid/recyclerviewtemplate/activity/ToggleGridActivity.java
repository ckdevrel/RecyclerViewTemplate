...
import com.takeoffandroid.recyclerviewtemplate.adapter.ToggleGridAdapter;


public class ToggleGridActivity extends AppCompatActivity {
    ...
    private ToggleGridAdapter mAdapter;
    ...
    private void setAdapter() {
        ...
        mAdapter = new ToggleGridAdapter(ToggleGridActivity.this, modelList);

        recyclerView.setHasFixedSize(true);


        final GridLayoutManager layoutManager = new GridLayoutManager(ToggleGridActivity.this, 2);
        ...
        mAdapter.SetOnItemClickListener(new ToggleGridAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(ToggleGridActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
        ...
        mAdapter.SetOnCheckedListener(new ToggleGridAdapter.OnCheckedListener() {
            @Override
            public void onChecked(View view, boolean isChecked, int position, AbstractModel model) {

                Toast.makeText(ToggleGridActivity.this, (isChecked ? "Checked " : "Unchecked ") + model.getTitle(), Toast.LENGTH_SHORT).show();
