...
public class SimpleListAcivity extends AppCompatActivity {
    ...
    private void setAdapter() {
        ...
        mAdapter = new SimpleListAdapter(SimpleListAcivity.this, modelList);
        ...
        mAdapter.SetOnItemClickListener(new SimpleListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, AbstractModel model) {
                ...
                Toast.makeText(SimpleListAcivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
