...
public class SimpleListCardsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SimpleListCardsAdapter(Context context, ArrayList<AbstractModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_simple_list_cards, viewGroup, false);
