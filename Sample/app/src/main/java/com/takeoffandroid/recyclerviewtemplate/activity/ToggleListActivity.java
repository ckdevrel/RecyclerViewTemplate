...
import com.takeoffandroid.recyclerviewtemplate.adapter.ToggleListAdapter;
...
public class ToggleListActivity extends AppCompatActivity {
    ...
    private void setAdapter() {
        ...
        mAdapter = new ToggleListAdapter(ToggleListActivity.this, modelList);
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(ToggleListActivity.this, R.drawable.divider_recyclerview));
        recyclerView.addItemDecoration(dividerItemDecoration);

        recyclerView.setAdapter(mAdapter);


        mAdapter.SetOnItemClickListener(new ToggleListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(ToggleListActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
        ...
        mAdapter.SetOnCheckedListener(new ToggleListAdapter.OnCheckedListener() {
            @Override
            public void onChecked(View view, boolean isChecked, int position, AbstractModel model) {

                Toast.makeText(ToggleListActivity.this, (isChecked ? "Checked " : "Unchecked ") + model.getTitle(), Toast.LENGTH_SHORT).show();
