...
import com.takeoffandroid.recyclerviewtemplate.adapter.SimpleListAllCardsAdapter;
...
public class SimpleListAllCardsActivity extends AppCompatActivity {
    ...
    private SimpleListAllCardsAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple_list_all_cards);
    ...
    private void setAdapter() {
        ...
        mAdapter = new SimpleListAllCardsAdapter(SimpleListAllCardsActivity.this, modelList);
        ...
        mAdapter.SetOnItemClickListener(new SimpleListAllCardsAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(SimpleListAllCardsActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
