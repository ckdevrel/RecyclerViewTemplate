...
import com.takeoffandroid.recyclerviewtemplate.adapter.RadioListAdapter;
...
public class RadioListActivity extends AppCompatActivity {
    ...
    private void setAdapter() {
        ...
        mAdapter = new RadioListAdapter(RadioListActivity.this, modelList);
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(RadioListActivity.this, R.drawable.divider_recyclerview));
        ...
        mAdapter.SetOnItemClickListener(new RadioListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, AbstractModel model) {
                ...
                Toast.makeText(RadioListActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
