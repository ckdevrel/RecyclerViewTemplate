...
import com.takeoffandroid.recyclerviewtemplate.adapter.SimpleGridCardsAdapter;


public class SimpleGridCardsActivity extends AppCompatActivity {
    ...
    private SimpleGridCardsAdapter mAdapter;
    ...
    private void setAdapter() {
        ...
        mAdapter = new SimpleGridCardsAdapter(SimpleGridCardsActivity.this, modelList);

        recyclerView.setHasFixedSize(true);


        final GridLayoutManager layoutManager = new GridLayoutManager(SimpleGridCardsActivity.this, 2);
        ...
        mAdapter.SetOnItemClickListener(new SimpleGridCardsAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(SimpleGridCardsActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
