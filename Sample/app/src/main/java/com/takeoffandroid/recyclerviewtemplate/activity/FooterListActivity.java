...
import com.takeoffandroid.recyclerviewtemplate.adapter.FooterListAdapter;
...
public class FooterListActivity extends AppCompatActivity {
    ...
    private FooterListAdapter mAdapter;
    ...
    private void setAdapter() {
        ...
        mAdapter = new FooterListAdapter(FooterListActivity.this, modelList, "Footer");
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(FooterListActivity.this, R.drawable.divider_recyclerview));
        recyclerView.addItemDecoration(dividerItemDecoration);

        recyclerView.setAdapter(mAdapter);


        mAdapter.SetOnItemClickListener(new FooterListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(FooterListActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
        ...
        mAdapter.SetOnFooterClickListener(new FooterListAdapter.OnFooterClickListener() {
            @Override
            public void onFooterClick(View view, String footerTitle) {

                //handle item click events here
                Toast.makeText(FooterListActivity.this, "Hey I am a footer", Toast.LENGTH_SHORT).show();
