 ...
 */
public class SimpleListAllCardsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SimpleListAllCardsAdapter(Context context, ArrayList<AbstractModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_simple_list_all_cards, viewGroup, false);
