...
import com.takeoffandroid.recyclerviewtemplate.adapter.SimpleListAllAdapter;
...
public class SimpleListAllActivity extends AppCompatActivity {
    ...
    private SimpleListAllAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple_list_all);
    ...
    private void setAdapter() {
        ...
        mAdapter = new SimpleListAllAdapter(SimpleListAllActivity.this, modelList);
        ...
        dividerItemDecoration.setDrawable(ContextCompat.getDrawable(SimpleListAllActivity.this, R.drawable.divider_recyclerview));
        ...
        scrollListener = new RecyclerViewScrollListener() {
            ...
            public void onEndOfScrollReached(RecyclerView rv) {
                ...
                Toast.makeText(SimpleListAllActivity.this, "End of the RecyclerView reached. Do your pagination stuff here", Toast.LENGTH_SHORT).show();
        ...
        mAdapter.SetOnItemClickListener(new SimpleListAllAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(SimpleListAllActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
