...
import com.takeoffandroid.recyclerviewtemplate.adapter.BannerGridAdapter;
import com.takeoffandroid.recyclerviewtemplate.GridMarginDecoration;
import com.takeoffandroid.recyclerviewtemplate.R;


public class BannerGridActivity extends AppCompatActivity {
    ...
    private void setAdapter() {
        ...
        mAdapter = new BannerGridAdapter(BannerGridActivity.this, modelList);

        recyclerView.setHasFixedSize(true);


        final GridLayoutManager layoutManager = new GridLayoutManager(BannerGridActivity.this, 2);
        recyclerView.addItemDecoration(new GridMarginDecoration(BannerGridActivity.this, 2, 2, 2, 2));
        ...
        mAdapter.SetOnItemClickListener(new BannerGridAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(BannerGridActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
