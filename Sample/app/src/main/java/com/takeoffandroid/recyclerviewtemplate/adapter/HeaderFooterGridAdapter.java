 ...
 */
public class HeaderFooterGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HeaderFooterGridAdapter(Context context, ArrayList<AbstractModel> modelList, String headerTitle, String footerTitle) {
