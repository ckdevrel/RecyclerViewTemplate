...
public class SimpleGridAllActivity extends AppCompatActivity {
    ...
    private SimpleGridAllAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple_grid_all);
    ...
    private void setAdapter() {
        ...
        mAdapter = new SimpleGridAllAdapter(SimpleGridAllActivity.this, modelList);

        recyclerView.setHasFixedSize(true);


        final GridLayoutManager layoutManager = new GridLayoutManager(SimpleGridAllActivity.this, 2);
        ...
        scrollListener = new RecyclerViewScrollListener() {
            ...
            public void onEndOfScrollReached(RecyclerView rv) {
                ...
                Toast.makeText(SimpleGridAllActivity.this, "End of the RecyclerView reached. Do your pagination stuff here", Toast.LENGTH_SHORT).show();
        ...
        mAdapter.SetOnItemClickListener(new SimpleGridAllAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(SimpleGridAllActivity.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
